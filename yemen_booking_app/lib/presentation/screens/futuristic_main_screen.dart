        ...
        return Positioned(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color: _navItems[_currentIndex].gradient.colors[0].withOpacity(0.5),
                      ...
                      AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: isSelected
                              ? [
                                  BoxShadow(
                                    color: item.gradient.colors[0].withOpacity(0.4),
                                    blurRadius: 10,
                                    spreadRadius: 1,
                                  ),
                                ]
                        ...
                        child: Center(
                          child: AnimatedSwitcher(
                            ...
                            child: Icon(
                              ...
                              key: ValueKey<String>('nav_icon_${index}_${isSelected ? 'active' : 'inactive'}'),
...
class _WaveEffectPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (double x = 0; x <= size.width; x += 5) {
      ...
      final waveHeight = (1 - normalizedDistance) * 15 * 
                         math.sin(animation * 2 * math.pi);
